...
'@ import sat/sab file: \\gamserverhp5.iteam.upv.es\PERFILES$\MSANLLI\Desktop\Joan\Conector\132432.sat
...
'@ rename component: default to: connector

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Component.Rename "default", "connector"

'@ rename block: connector:import_1 to: connector:connector

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Solid.Rename "connector:import_1", "connector"

'@ transform: rotate connector:connector
...
'@ transform: translate connector:connector
...
'@ split shape: connector:connector

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Solid.SplitShape "connector", "connector"

'@ align: Faces connector:connector

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
With Pick 
     .PickFaceFromId "connector:connector", "18" 
     .PickFaceFromId "component1:substrate", "1" 
End With 
...
'[VERSION]2024.4|33.0.1|20240430[/VERSION]
With Pick 
     .PickFaceFromId "connector:connector", "1" 
     .PickFaceFromId "component1:substrate", "5" 
End With 
...
'@ delete shape: connector:connector

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Solid.Delete "connector:connector"

'@ new component: connector/connector

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Component.New "connector/connector"

'@ import parasolid file: \\gamserverhp5.iteam.upv.es\PERFILES$\MSANLLI\Desktop\Joan\Conector\132432.x_b

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
With Parasolid
     .Reset 
     .ScaleToUnit "0" 
     .FileName "\\gamserverhp5.iteam.upv.es\PERFILES$\MSANLLI\Desktop\Joan\Conector\132432.x_b" 
     .Id "2" 
     .Curves "True" 
...
'@ import step file: \\gamserverhp5.iteam.upv.es\PERFILES$\MSANLLI\Desktop\Joan\Conector\132432.stp

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
With STEP
     .Reset 
     .ScaleToUnit "0" 
     .FileName "\\gamserverhp5.iteam.upv.es\PERFILES$\MSANLLI\Desktop\Joan\Conector\132432.stp" 
     .Id "3" 
     .Version "11.0" 
     .ImportToActiveCoordinateSystem "True" 
     .Curves "True" 
...
'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickFaceFromId "default:132432_SW0001", "80"

'@ pick edge

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEdgeFromId "default:132432_SW0001", "207", "135"

'@ pick face

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickFaceFromId "default:132432_SW0001", "81"

'@ pick edge

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEdgeFromId "default:132432_SW0001", "208", "135"

'@ pick face

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickFaceFromId "default:132432_SW0001", "82"

'@ pick face

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickFaceFromId "default:132432_SW0001", "84"

'@ pick edge

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEdgeFromId "default:132432_SW0001", "212", "137"

'@ pick edge

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEdgeFromId "default:132432_SW0001", "210", "136"

'@ pick face

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickFaceFromId "default:132432_SW0001", "83"

'@ pick edge

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEdgeFromId "default:132432_SW0001", "206", "134"

'@ pick edge

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEdgeFromId "default:132432_SW0001", "205", "134"

'@ unpick edge

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.UnpickEdgeFromId "default:132432_SW0001", "207", "135"
...
With Material 
     ...
     .ThermalExpansionRateVolume "17"
     .SpecificHeat "420", "J/K/kg"
     .DynamicViscosity "0"
     .UseEmissivity "False"
     .Emissivity "0"
     .MetabolicRate "0.0"
...
'@ change material: default:132432_SW0001 to: Cobre Berilio

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Solid.ChangeMaterial "default:132432_SW0001", "Cobre Berilio"

'@ split shape: default:132432_SW0001

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Solid.SplitShape "132432_SW0001", "default"
...
'@ change material: default:132432_SW0001 to: Brass (91%)

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Solid.ChangeMaterial "default:132432_SW0001", "Brass (91%)"
...
'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEdgeFromId "default:132432_SW0001", "209", "135"
...
'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEdgeFromId "default:132432_SW0001", "211", "134"
...
'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEndpointFromId "default:132432_SW0001", "134"

'@ pick end point

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEndpointFromId "default:132432_SW0001", "137"

'@ pick end point

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEndpointFromId "default:132432_SW0001", "135"

'@ pick end point

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEndpointFromId "default:132432_SW0001", "136"

'@ define material colour: Cobre Berilio
...
'@ import step file: \\gamserverhp5.iteam.upv.es\PERFILES$\MSANLLI\Desktop\Joan\Conector\132432(2).stp

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
With STEP
     .Reset 
     .ScaleToUnit "0" 
     .FileName "*132432(2).stp" 
     .Id "1" 
     .Version "11.0" 
     .ImportToActiveCoordinateSystem "True" 
     .Curves "True" 
...
'@ make shape from faces: default:connector_pin

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Solid.CreateShapeFromFaces "connector_pin", "default", "Cobre Berilio"

'@ split shape: default:connector_pin

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Solid.SplitShape "connector_pin", "default"

'@ transform: translate default:connector_pin

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
With Transform 
     .Reset 
     .Name "default:connector_pin" 
     .Vector "0", "0.1", "0" 
     .UsePickedPoints "False" 
     .InvertPickedPoints "False" 
     .MultipleObjects "False" 
...
'@ delete shape: default:connector_pin

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Solid.Delete "default:connector_pin"
...
'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEdgeFromId "default:132432_SW0001", "18", "18"

'@ pick edge

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEdgeFromId "default:132432_SW0001", "17", "17"

'@ unpick face

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.UnpickFaceFromId "default:132432_SW0001", "81"
...
'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEndpointFromId "default:132432_SW0001", "18"

'@ unpick edge

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.UnpickEdgeFromId "default:132432_SW0001", "18", "18"
...
'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEndpointFromId "default:132432_SW0001", "17"

'@ unpick edge

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.UnpickEdgeFromId "default:132432_SW0001", "17", "17"
...
'@ remove features of shape: default:132432_SW0001

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
With LocalModification 
     .Reset 
     .Name "default:132432_SW0001"
     .RemoveSelectedFaces 
End With
...
'@ boolean subtract shapes: default:132432_SW0001_1, default:132432_SW0001

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Solid.Subtract "default:132432_SW0001_1", "default:132432_SW0001"

'@ change material: default:132432_SW0001_1 to: Cobre Berilio

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Solid.ChangeMaterial "default:132432_SW0001_1", "Cobre Berilio"

'@ change component: default:132432_SW0001_1 to: connector:132432_SW0001_1

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Solid.ChangeComponent "default:132432_SW0001_1", "connector"
...
'@ rename block: connector:132432_SW0001_1 to: connector:connector_pin

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Solid.Rename "connector:132432_SW0001_1", "connector_pin"

'@ rename block: connector:132432_SW0001 to: connector:connector_body

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Solid.Rename "connector:132432_SW0001", "connector_body"

'@ align: Faces selected

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
With Pick 
     .PickFaceFromId "connector:connector_body", "1" 
     .PickFaceFromId "component1:substrate", "5" 
End With 

With Align
     .Reset 
     .Name "connector:connector_body" 
     .AddName "connector:connector_pin" 
     .SetKindOfPickFor "SourcePlane", "Face" 
     .SetKindOfPickFor "TargetPlane", "Face" 
     .Align "Shapes", "Faces" 
End With

'@ align: RotateByDegree selected
...
With Align
     ...
     .AddName "connector:connector_pin" 
     .SetKindOfPickFor "TargetPlane", "Face" 
     .SetNumericalValue "Angle", "270" 
     .Align "Shapes", "RotateByDegree" 
End With
...
With Transform 
     ...
     .Touch "True"
     .TouchTolerance "1e-6"
     .AddNameToActiveTouchSet "connector"
     .Transform "Shape", "Translate" 
End With

'@ transform: translate connector:connector_pin

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
With Transform 
     .Reset 
     .Name "connector:connector_pin" 
     .Vector "0", "0", "-0.0001" 
     .UsePickedPoints "False" 
     .InvertPickedPoints "False" 
     .MultipleObjects "False" 
     ...
     .Touch "True"
     .TouchTolerance "1e-6"
     .AddNameToActiveTouchSet "connector:connector_pin"
     .AddNameToPassiveTouchSet "component1:feed_line"
     .AddNameToPassiveTouchSet "component1:ground"
     .AddNameToPassiveTouchSet "component1:matching_line"
     .AddNameToPassiveTouchSet "component1:patch"
     .AddNameToPassiveTouchSet "component1:substrate"
     .Transform "Shape", "Translate" 
End With

'@ transform: translate connector:connector_body
...
'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickFaceFromId "connector:connector_pin", "159"

'@ pick face chain

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickFaceChainFromId "connector:connector_pin", "162"

'@ pick solid edge chain

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickSolidEdgeChainFromId "connector:connector_pin", "416", "163"

'@ pick solid edge chain

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickSolidEdgeChainFromId "connector:connector_pin", "410", "162"

'@ pick solid edge chain

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickSolidEdgeChainFromId "connector:connector_pin", "412", "161"

'@ pick edge

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEdgeFromId "connector:connector_pin", "411", "268"

'@ pick edge

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEdgeFromId "connector:connector_pin", "409", "267"

'@ pick end point

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEndpointFromId "connector:connector_pin", "268"

'@ pick end point

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEndpointFromId "connector:connector_pin", "269"

'@ pick end point

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEndpointFromId "connector:connector_pin", "270"

'@ pick end point

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickEndpointFromId "connector:connector_pin", "267"
...
With DiscretePort 
     ...
     .Monitor "True"
     .Radius "0.0"
     .SetP1 "True", "-0.2799892688765", "17.615518281203", "0.38519121139394"
     .SetP2 "True", "-0.38", "17.715532845429", "0.38519121139394"
...
'@ delete port folder: Folder1

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Port.DeleteFolder "Folder1"
...
With Port 
     ...
     .PortOnBound "True"
     .ClipPickedPortToBound "False"
     .Xrange "-30.431153242362", "-30.431153242362"
     .Yrange "-33.109483992172", "44.863547056372"
     .Zrange "-16.552837273455", "17.323219696242"
     .XrangeAdd "0.0", "0.0"
     .YrangeAdd "0.0", "0.0"
     .ZrangeAdd "0.0", "0.0"
     .SingleEnded "False"
...
'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickFaceFromId "connector:connector_pin", "1"
...
With Port 
     ...
     .ClipPickedPortToBound "False"
     .Xrange "-0.38", "0.38"
     .Yrange "22.995518281203", "22.995518281203"
     .Zrange "0.0051912113939391", "0.76519121139394"
     .XrangeAdd "0.0", "0.0"
     .YrangeAdd "0.0", "0.0"
     .ZrangeAdd "0.0", "0.0"
     .SingleEnded "False"
...
With Port 
     ...
     .ClipPickedPortToBound "False"
     .Xrange "-0.38", "0.38"
     .Yrange "22.995518", "22.995518"
     .Zrange "0.005191", "0.765191"
     .XrangeAdd "0.0", "0.0"
     .YrangeAdd "0.0", "0.0"
     .ZrangeAdd "0.0", "0.0"
     .SingleEnded "False"
...
With Port 
     ...
     .Xrange "-0.38", "0.38"
     .Yrange "22.995518", "22.995518"
     .Zrange "0.0051912113939394", "0.765191"
     .XrangeAdd "0.0", "0.0"
     .YrangeAdd "0.0", "0.0"
     .ZrangeAdd "metal_thickness", "0.0"
     .SingleEnded "False"
...
'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickFaceFromId "component1:feed_line", "1"
...
With Port 
     ...
     .PortOnBound "False"
     .ClipPickedPortToBound "False"
     .Xrange "-0.94125538120305", "0.94125538120305"
     .Yrange "15.0510013709", "22.995518281203"
     .Zrange "0.0051912113939394", "0.0051912113939394"
     .XrangeAdd "0.0", "0.0"
     .YrangeAdd "0.0", "0.0"
     .ZrangeAdd "0.0", "0.0"
     .SingleEnded "False"
...
With Port 
     ...
     .AdjustPolarization "False"
     .PolarizationAngle "0.0"
     .ReferencePlaneDistance "-metal_thickness*1.1"
     .TextSize "50"
     .TextMaxLimit "0"
     .Coordinates "Picks"
     .Orientation "positive"
     .PortOnBound "False"
     .ClipPickedPortToBound "False"
     .Xrange "-0.941255", "0.941255"
     .Yrange "15.051001", "22.995518"
     .Zrange "0.005191", "0.005191"
     .XrangeAdd "0.0", "0.0"
     .YrangeAdd "0.0", "0.0"
     .ZrangeAdd "0.0", "0.0"
     .SingleEnded "False"
...
'@ rename component: component1 to: patch

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Component.Rename "component1", "patch"

'@ pick face

'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickFaceFromId "patch:feed_line", "5"
...
'[VERSION]2024.4|33.0.1|20240430[/VERSION]
Pick.PickFaceFromId "connector:connector_body", "1"
...
With Port 
     ...
     .Xrange "-4.76", "4.76"
     .Yrange "22.995518281203", "22.995518281203"
     .Zrange "-3.5748087886061", "4.3451912113939"
     .XrangeAdd "0.0", "0.0"
     .YrangeAdd "0.0", "0.0"
     .ZrangeAdd "0.0", "0.0"
     .SingleEnded "False"
